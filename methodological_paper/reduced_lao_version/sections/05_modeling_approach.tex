...
\begin{figure}[htbp]
    \centering
    \captionwithnote{Modeling approach}{}
...
\begin{figure}[htbp]
    \centering
    \captionwithnoteandshort{Causal Graph Underlying our Approach}{Causal Graph Between Economic Activity, Climate, and Disasters}{Dotted circles represent unobserved variables. Arrows connect concepts causally, so that $A \rightarrow B$ implies that $A$ causes $B$.}
