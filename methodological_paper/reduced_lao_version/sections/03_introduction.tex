...
The current paper develops a methodology to quantify countries' exposure to climate change-related disasters, and presents an example of its application for the Lao People's Democratic Republic. The methodology is implemented by one joint model called \textbf{Probabilistic Geospatial Risk (PGR) model}.
