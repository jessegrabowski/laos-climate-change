...
The geolocated return-year curves for specific locations (e.g., Desamparados, El Bamb\'{u}, and Cariari in Costa Rica) illustrate how communities can use these tools to assess their unique risks and plan targeted adaptations, such as infrastructure upgrades or early warning systems.
...
\begin{itemize}
    ...
    \item Spatial shifts in vulnerability, with urban centers (e.g., Costa Rica's Greater Metropolitan Area) and regions close to rivers facing disproportionate risks due to population density and geographic exposure.
\end{itemize}
